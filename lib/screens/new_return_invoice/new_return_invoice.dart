...
import 'package:eit/screens/new_return_invoice/save_files.dart';
...
import '../new_invoice/items_dropdown_widget.dart';

class NewReturnInvoice extends GetView<SalesController> {
  const NewReturnInvoice({super.key});
                  ...
                  child: Obx(
                    () => controller.isVisit.value
                        ? Card(
                            child: ListTile(
                              title: Text(
                                  controller.customerModel?.custName ?? ''),
                              trailing: const Icon(
                                Icons.person,
                                color: accentColor,
                              ),
